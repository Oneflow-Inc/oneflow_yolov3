...
--total_batch_num=8 --gpu_num_per_node=1 --batch_size=1  \
--model_load_dir=$model_dir --image_list_path=$image_list_file \
--label_to_name_file=$label_2_name_file --use_tensorrt=1  \
